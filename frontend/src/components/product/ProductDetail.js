...
export default function ProductDetail() {
    ...
    useEffect(() => {
        ...
        recognition.onresult = (event) => {
            ...
            if (speechResult.includes('add to cart')) {
        ...
        const voiceAddToCartBtn = document.getElementById('voice_add_to_cart_btn');
        if (voiceAddToCartBtn) {
            voiceAddToCartBtn.addEventListener('click', startRecognition);
        }

        return () => {
            if (voiceAddToCartBtn) {
                voiceAddToCartBtn.removeEventListener('click', startRecognition);
            }
        };
                ...
                <Fragment>
                    ...
                    <div className="row f-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            <p id="product_price">${product.price} <span> (≈ ₹{priceInRupees.toFixed(2)})</span></p>
                            ...
                            >Add to Cart</button>
                            <button id="voice_add_to_cart_btn" className="btn btn-secondary d-inline ml-4 mt-2">Voice Add to Cart</button>
